...
from cobo.utils.mol_utils.selfies_vae.data import SELFIESDataModule, SELFIESDataset
...
class InfoTransformerVAE(pl.LightningModule):
    ...
    def forward(self, tokens):
        ...
        recon_loss_all = F.cross_entropy(logits.permute(0, 2, 1), tokens, reduction='none')
        recon_loss = recon_loss_all.mean()  # .sum(1).mean(0)
